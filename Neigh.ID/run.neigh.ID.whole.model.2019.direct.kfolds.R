...
for (D in datas){
  ...
  for (t in mode.types) {
    ...
    saveRDS(alpha.models.AB,paste0("Neigh.ID/output/",D,".alpha.model.list.",t,"fold.",k,".2019.rds"))
    ...
    saveRDS(alpha.beta.models.AB,paste0("Neigh.ID/output/",D,".alpha.beta.model.list.",t,"fold.",k,".2019.rds"))  
  ...
  ## write summary csv
  write.csv(sum,paste0("Neigh.ID/output/",D,".neighbor.ID.summary.2019.direct.kfolds.csv"))
